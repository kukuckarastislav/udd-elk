...
public class SearchServiceImpl implements SearchService {
    ...
    public Page<IndexUnit> search(SearchDTO searchDTO, Pageable pageable) {
        ...
        var query = BoolQuery.of(b -> {
            ...
            if(searchDTO.getTypeOfSearch().equals("standard_search")){
                ...
                if(searchDTO.isContractDoc() && searchDTO.isLawDoc()) {
                    ...
                    /*
                    var aa = QueryBuilders.geoDistanceQuery("location")
                            .point(44.7866, 20.4489)
                            .distance(100, DistanceUnit.KILOMETERS);

                    List<Query> geoFilter = new ArrayList<>();
                    geoFilter.add(aa);
        ...
        //query.geoDistance(gdq -> gdq.("location").point(44.7866, 20.4489).distance(100, DistanceUnit.KILOMETERS));
        ...
        GeoDistanceQueryBuilder geoDistanceQueryBuilder = QueryBuilders
                ...
                .point(44.7866, 20.4489)
                .distance(100, DistanceUnit.KILOMETERS);
        System.out.println("GEO LOCATION: "+geoDistanceQueryBuilder.toString());
        query.filter().add(geoDistanceQueryBuilder.);
        */
        ...
        nativeQueryBuilder.withQuery(q -> q.bool(b -> {
                 ...
                 */
                        ...
                        /*
                        b.must(QueryBuilders.geoDistanceQuery("location")
                                .point(44.7866, 20.4489)
                                .distance(100, DistanceUnit.KILOMETERS));
*/
                        System.out.println("//////////////////// ORIGINAL query: " + searchDTO.getBooleanQuery());
        ...
        return runQuery1(nativeQueryBuilder.build());
    }
